...
describe 'cloudkitty::keystone::authtoken' do
  ...
  shared_examples 'cloudkitty::keystone::authtoken' do

    context 'with default parameters' do

      it 'configure keystone_authtoken' do
        is_expected.to contain_keystone__resource__authtoken('cloudkitty_config').with(
          :username                       => 'cloudkitty',
          :password                       => 'cloudkitty_password',
  ...
  on_supported_os({
    ...
    context "on #{os}" do
      ...
      it_configures 'cloudkitty::keystone::authtoken'
    end
  end
